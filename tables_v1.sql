...
CREATE TABLE IF NOT EXISTS `rg_share1_file` (
...
CREATE TABLE IF NOT EXISTS `rg_share1_file_cont` (
  ...
  CONSTRAINT `fk_rg_share1_file_cont` FOREIGN KEY (`file_id`) REFERENCES `rg_share1_file` (`file_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;


CREATE TABLE IF NOT EXISTS `rg_user1_file` (
...
CREATE TABLE IF NOT EXISTS `rg_user1_file_cont` (
  `user_id` varchar(50) NOT NULL,
  `file_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `level` int NOT NULL,
  `page` int NOT NULL,
  ...
  CONSTRAINT `fk_rg_user1_file_cont` FOREIGN KEY (`user_id`, `file_id`) REFERENCES `rg_user1_file` (`user_id`, `file_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
